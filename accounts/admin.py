...
class UserAdmin(BaseUserAdmin):
	...
	list_display = ('email', 'first_name', 'last_name', 'is_admin', 'vrify_email')
	list_filter = ('is_admin',)
	readonly_fields = ('last_login',)

	fieldsets = (
		('Main', {'fields':('email', 'first_name', 'last_name', 'password')}),
		('Permissions', {'fields':('is_active', 'is_admin', 'is_superuser', 'vrify_email','last_login', 'groups', 'user_permissions')}),
	)
